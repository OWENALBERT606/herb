...
const words = ["justice", "victory", "vindication", "acquittal"];
        ...
        return (
          <span
            ...
            style={{
              ...
              color: showGradient ? `rgb(${r},${g},${b})` : undefined,
...
const stats = [
  { value: "Court Victory", label: "civil, criminal & family cases" },
  { value: "Sacred Rituals", label: "herbs, invocations & charms" },
  { value: "+ More", label: "love, wealth, health & marriage" },
];
...
export function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen flex flex-col justify-center items-start overflow-hidden bg-black">
        ...
        <div className="lg:max-w-[55%]">
          ...
          >
            <span className="inline-flex items-center gap-3 text-sm font-mono text-white/60">
              ...
              Ancestral Spells That Deliver Court Victories
            </span>
          </div>
      ...
      {/* Stats — 3 highlights static, no auto-scroll */}
      <div
